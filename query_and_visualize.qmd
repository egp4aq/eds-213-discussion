...
```{r}
# --> looks like this is just because there's more legos made later maybe
...
```{r}
# okay new thinking: pink is my favorite color! let me see which of these themes have the most pink
